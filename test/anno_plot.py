import cv2
path = '/media/yaesop/ARL_FZNV/DTRA/DTRA_png_new/DTRA_Trial-10_CIR_VIS_15m_45deg_cam_10sec_8941_5.png'

myimg = cv2.imread(path)
with open('/media/yaesop/ARL_FZNV/DTRA/DTRA_gt/lying/DTRA_Trial-10_CIR_VIS_15m_45deg_cam_10sec_8941_5.txt') as f:
    for line in f:
        bbox= line.split(" ")
        #print(bbox)
        minx = float(bbox[1])
